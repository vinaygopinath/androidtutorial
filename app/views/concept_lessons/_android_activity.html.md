...
Summarizing the chapter, you understood why an Android Activity Lifecycle exists, what is its importance and what are the different Lifecycle states which an activity goes through.
